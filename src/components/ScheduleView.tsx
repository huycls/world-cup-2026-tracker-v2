    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
      {isLoading && matches.length === 0 ? (
        <div className="lg:col-span-12 flex flex-col items-center justify-center py-24 text-neutral-400">
          ...
          <p className="text-sm font-semibold">Đang tải lịch thi đấu WC 2026...</p>
        ...
        <div className="lg:col-span-12 flex flex-col items-center justify-center py-24 text-neutral-400">
          ...
          <p className="text-xs text-neutral-600 mt-1">Không thể tải lịch thi đấu từ API. Vui lòng thử tải lại trang.</p>
        </div>
      ) : (
        <>
      <div className="lg:col-span-12 flex items-center justify-between px-1 mb-1">
        ...
        <p className="text-[10px] text-[#D4AF37]/60 font-mono">worldcup26.ir</p>
      </div>
            ...
            {filteredMatches.map((match) => {
              ...
              return (
                <motion.div
                  ...
                  className={`border rounded-xl p-3.5 transition-all min-h-10 duration-300 cursor-pointer relative overflow-hidden group ${
                    isSelected
          ...
          {activeMatch ? (
            <motion.div
              ...
              <div className="flex-1 flex flex-col min-h-[300px] overflow-hidden relative z-10">
                <div className="flex items-center gap-1.5 text-xs font-sans font-bold text-neutral-400 uppercase tracking-wider border-b border-[#D4AF37]/15 pb-2 mb-3">
                  <Activity className="w-3.5 h-3.5 text-[#D4AF37]" /> Đội Hình
                  Ra Sân (Starting Lineup)
                </div>
                    ...
                    <div>
                      ...
                      {team1 ? (
                        ...
                        <p className="text-[11px] text-neutral-600 italic">
                          Chi tiết đội hình sẽ được hiển thị khi đội giành vé đi
                          tiếp.
                        </p>
                      )}
                    </div>
            ...
            <div className="bg-[#111] border border-[#D4AF37]/20 rounded-xl p-6 flex flex-col items-center justify-center text-center text-neutral-500 h-full">
              ...
              <p className="text-[10px] text-neutral-600 mt-1">
                Bấm vào bất kỳ trận đấu nào ở danh sách bên trái để xem đội hình
                ra sân và thông tin địa điểm.
              </p>
            </div>
          )}
        </AnimatePresence>
